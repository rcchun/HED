...
# def write_txt(dataRoot,filename,img_paths):
#     print(img_paths)
#     txtfile = open(os.path.join(dataRoot,filename),'w')
...
def make_txt(dataRoot,dataType):
    ...
    # img_paths = glob.glob(os.path.join(dataRoot, dataType, 'filteredimg/*.jpg'))
...
# def make_txt(dataRoot,dataType):
#     img_paths = glob.glob(os.path.join(dataRoot,'*.jpg'))
#     img_paths = sorted(img_paths)
#     write_txt(dataRoot,dataType+'.lst',img_paths)


def random_make_txt(dataRoot,numOfVal,numOfTest):
    img_paths = glob.glob(os.path.join(dataRoot, 'croppedimg/*.jpg'))
    # img_paths = glob.glob(os.path.join(dataRoot, 'filteredimg/*.jpg'))
...
def writeAll(dataRoot):
    ...
    # img_paths = glob.glob(os.path.join(dataRoot, 'test/filteredimg/*.jpg'))
    ...
    for img_path in img_paths:
        ...
        # saved_gt = saved_img.replace('filteredimg', 'croppedgt').replace('jpg', 'png')
        txtfile.write('{} {}\n'.format(saved_img, saved_gt))
